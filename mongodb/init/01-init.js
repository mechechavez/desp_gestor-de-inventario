...
// Conectar a la base de datos admin para crear el usuario de la aplicación
db = db.getSiblingDB('admin');

// Crear la base de datos y cambiar a ella
db = db.getSiblingDB('gestor_inventario');

// Crear usuario para la aplicación (opcional, ya que usamos admin para simplificar)
db.createUser({
  user: 'gestor_user',
  pwd: 'gestor_password',
  roles: [
